.text:00401050		;
.text:00401050		; +-------------------------------------------------------------------------+
.text:00401050		; |   This file has been	generated by The Interactive Disassembler (IDA)	   |
.text:00401050		; |	     Copyright (c) 2013	Hex-Rays, <support@hex-rays.com>	   |
.text:00401050		; |			License	info:                			   |
.text:00401050		; |				  Microsoft				   |
.text:00401050		; +-------------------------------------------------------------------------+
.text:00401050		;
.text:00401050
.text:00401050		; ---------------------------------------------------------------------------
.text:00401050		; Format	     : Portable	executable for 80386 (PE)
.text:00401050		; Imagebase   : 400000
.text:00401050		; Section 1. (virtual address 00001000)
.text:00401050		; Virtual size		       : 0002964D ( 169549.)
.text:00401050		; Section size in file	       : 00029800 ( 169984.)
.text:00401050		; Offset	to raw data for	section: 00000400
.text:00401050		; Flags 60000020: Text Executable Readable
.text:00401050		; Alignment     : default
.text:00401050		; OS type	 :  MS Windows
.text:00401050		; Application type:  Executable 32bit
.text:00401050
.text:00401050		include uni.inc ; see unicode subdir of ida for info on unicode
.text:00401050
.text:00401050		.686p
.text:00401050		.mmx
.text:00401050		.model flat
.text:00401050
.text:00401050		; ===========================================================================
.text:00401050
.text:00401050		; Segment type: Pure code
.text:00401050		; Segment permissions: Read/Execute
.text:00401050		_text        segment para public 'CODE' use32
.text:00401050		assume cs:_text
.text:00401050		;org 401000h
.text:00401050		assume es:nothing, ss:nothing, ds:_data,	fs:nothing, gs:nothing
...
.text:0042A80E ?? ?? ??	?? ?? ?? ?? ?? ?? ?? ??	?? ?? ?? ?? ??+
.text:0042A80E 00+          __invalid_parameter
