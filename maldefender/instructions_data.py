"""
Instruction dictionaries used by InstBuilder
"""
DataInstList = ['dd', 'db', 'dw', 'dq', 'dt',
                'extrn',
                'unicode',]
...
"""
Instruction dictionaries used in block attributes extraction.
"""
MathInstList = [
    'aaa', 'aad', 'aam', 'aas', 'adc', 'add', 'addpd',
    'addps', 'addsd', 'addss', 'addsubpd', 'addsubps',
...
MathInstDict = {k: v for v, k in enumerate(MathInstList)}

VmxInstList = [
    'vmlaunch', 'vmmcall',
] # only in testset, not usable in trainning
...
CmpInstDict = {k: v for v, k in enumerate(CmpInstList)}
...
MovInstDict = {k: v for v, k in enumerate(MovInstList)}
